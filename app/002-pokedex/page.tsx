	...
	return (
		<div className='h-full flex flex-col justify-around'>
			...
			<div className='flex items-center justify-center'>
				<Link href='002-pokedex/pokedex' className='pokedex-box-button bg-gray-300 p-4 shadow-xl group'>
					<svg
						xmlns='http://www.w3.org/2000/svg'
						viewBox='0 0 24 24'
						className='size-12 text-blue-950 group-hover:text-yellow-700/60 transition'>
						<g
							fill='none'
							stroke='currentColor'
							strokeLinecap='round'
